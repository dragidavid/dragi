...
// do a bouncy version instead.. just one icon in the middle which if clicked, jumps up, rotates into another icon and lands
  ...
  return (
    <div className="grid-tile flex items-center justify-center">
      <div
        ...
        className={`flex h-14 w-24 ${
          theme === "dark" ? "justify-start" : "justify-end"
        } dark:ring-steel rounded-full bg-gray-100 p-2 dark:bg-black dark:ring-4`}
      >
        <motion.div
          className="dark:bg-steel h-full w-10 rounded-full bg-white p-2"
          layout
